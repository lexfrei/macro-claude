namespace Loupedeck.MacroClaudePlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.MacroClaudePlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.MacroClaudePlugin.Resources.Resource.txt`.
